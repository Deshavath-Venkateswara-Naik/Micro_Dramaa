...
def main():
    ...
    print("Starting BGM Intelligence Test...")
    processor = BgmIntelligenceProcessor(output_base_dir=output_dir)
    results = processor.process_bgm(video_id, scene_metadata_path)
